...
def choose_ranged():
    ...
    if wepchoice == None:
        ...
        if wepchoice == 'Six-Shooter':
            #bow stats/damage
            fire_ranged(shotrange=5, damage=5, ammo='Bullet')
...
def place_objects(room):
    ...
    monster_chances = {}
    monster_chances['town idiot'] =    30  #gerblin always shows up, even if all other monsters have 0 chance
    monster_chances['insane miner'] =   30
    monster_chances['straight up cowboy'] =  30
    ...
    item_chances = {}
    item_chances['six shooter'] =       2
    item_chances['bullet'] =     10
    ...
    for i in range(num_monsters):
        ...
        if not is_blocked(x, y):
            ...
            if choice == 'town idiot':
                ...
                monster = Object(x, y, 'i', 'Town Idiot', libtcod.desaturated_green,
                                 blocks=True, fighter=fighter_component, ai=ai_component)
 
            elif choice == 'insane miner':
                ...
                monster = Object(x, y, 'm', 'Insane Miner', libtcod.dark_orange,
                                 blocks=True, fighter=fighter_component, ai=ai_component)
 
            elif choice == "straight up cowboy":
                ...
                monster = Object(x, y, 'c', 'Straight-Up Cowboy', libtcod.red,
                                blocks=True, fighter=fighter_component, ai=ai_component)            
    ...
    for i in range(num_items):
        ...
        if not is_blocked(x, y):
            ...
            if choice == 'bullet':
                #create a stack of bullets
                item_component = Item(stacks=True, count=5, use_function=None, pickup_sound=None, use_sound=None)
                item = Object(x, y, '-', 'Bullet', libtcod.sepia, item=item_component)
            
            elif choice == 'six shooter':
                #create a bow
                equipment_component = Equipment(slot='right hand', shotrange=5, range_damage=10)
                item = Object(x, y, ']', 'Six-Shooter', libtcod.darker_sepia, equipment=equipment_component)
...
def new_game():
    ...
    message("Welcome stranger! Prepare to perish in the a sea of whiskey and lindum.", libtcod.red)
    ...
    equipment_component = Equipment(slot='right hand', shotrange=5, range_damage=10)
    item = Object(0, 0, ']', 'Six-Shooter', libtcod.darker_sepia, equipment=equipment_component)
    inventory.append(item)
    
    item_component = Item(stacks=True, count=5, use_function=None, pickup_sound=None, use_sound=None)
    item = Object(0, 0, '-', 'Bullet', libtcod.sepia, item=item_component)
    inventory.append(item)
...
def next_level():
    ...
    dungeon_level += 1
    message('You descend deeper into the heart of depravity...', libtcod.light_red)
